...
const Signup = () => {
    ...
    return (
        <div>
            <div className='mx-auto mt-10 w-[400px] md:w-[480px] h-[709px]'>
                <h1 className="font-bold text-[40px] flex items-center pl-[120px]">
                    <Image src={Logo} alt="logo" width={40} height={40} />
                    <span>devlinks</span>
                </h1>
                <div className='w-[380px] md:w-[476px] h-[618px] mt-7 pb-[30px] bg-white'>
                    <div className='w-[320px] md:w-[400px] mx-auto py-16'>
                        ...
                        <form className='w-full flex flex-col pt-7' onSubmit={handleSubmit}>
                            ...
                            <input
                                className='my-2 border rounded-md w-[311px] md:w-[396px] h-[48px] hover:border-[#633CFF] duration-200 '
                                type='email'
